...
const sslOptions = {
  key: fs.readFileSync(
    "/etc/letsencrypt/live/lms-korean.ddns.net/privkey.pem"
  ),
  cert: fs.readFileSync(
    "/etc/letsencrypt/live/lms-korean.ddns.net/fullchain.pem"
  )
};

https.createServer(sslOptions, app).listen(process.env.PORT, () => {
  console.log(
    `HTTPS Server running on port ${process.env.PORT}`
  );
});
